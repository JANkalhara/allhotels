...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$user || !password_verify($password, $user['password_hash'])) {
        ...
        if ($user['role'] === 'owner') redirect('../owner/dashboard.php');
...
<div class="container">
    <div class="auth-wrap">
        <div class="auth-card">
            <h2>Welcome Back</h2>
            <p class="auth-sub">Log in to manage bookings, reviews, or your hotel listings.</p>

            <?php if ($flash_login): ?><div class="alert alert-success"><?= h($flash_login) ?></div><?php endif; ?>
